...
<footer id="contact" class="scroll-mt-20 border-t border-line">
	<div class="mx-auto grid max-w-6xl gap-10 px-5 py-16 sm:py-20 lg:grid-cols-[1.2fr_1fr] lg:items-center">
		...
		<nav class="flex flex-wrap gap-4" aria-label="Contact and social">
			<a
				class="glass group inline-flex items-center justify-center p-4 transition-colors hover:border-accent/60 hover:text-accent"
				href="mailto:boujnanemohamed23@gmail.com"
				aria-label="Email"
			>
			...
			<a
				class="glass group inline-flex items-center justify-center p-4 transition-colors hover:border-accent/60 hover:text-accent"
				href="https://www.linkedin.com/in/mboujnane"
				target="_blank"
				rel="noopener"
				aria-label="LinkedIn"
			>
