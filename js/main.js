...
(function () {
    ...
    var I18N = {
        it: {
            ...
            "proj1.desc": "Scanner azionari algoritmici — uno screening GARP di lungo periodo (Finnhub) e una scansione di breve periodo (Alpha Vantage) — eseguiti su job cron pianificati con GitHub Actions, più una dashboard heatmap live dell'S&P 500.",
        ...
        fr: {
            ...
            "proj1.desc": "Scanners d'actions algorithmiques — un filtre GARP de long terme (Finnhub) et un scan de court terme (Alpha Vantage) — exécutés via des tâches cron planifiées sur GitHub Actions, plus un tableau de bord heatmap S&P 500 en direct.",
        ...
        ja: {
            ...
            "hero.lede": "生のマーケットデータを意思決定に変えるデータ＆AIスペシャリスト。<strong>dbt・Snowflake・Databricks</strong> でデータパイプラインを構築し、<strong>AIとマルチエージェント・オーケストレーション</strong>でワークフローを自動化、Python で<strong>Vela</strong> のような<strong>アルゴリズム型マーケットスキャナー</strong>を開発します — 金融戦略と技術的自動化をつなぎます。",
            "hero.cta1": "プロジェクトを見る",
            "stack.kicker": "// コアスタック",
            "stack.title": "ツールキット",
            ...
            "proj.automation": "自動化",
            "proj.production": "本番",
            "proj1.desc": "アルゴリズム型の株式スキャナー — 長期GARPスクリーン（Finnhub）と短期スキャン（Alpha Vantage） — GitHub Actionsのcronジョブで定期実行。ライブのS&P 500ヒートマップダッシュボード付き。",
            "proj2.title": "会話型AI",
